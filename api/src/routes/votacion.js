...
routes.get('/votacion', tokenController.verifyToken, votacionController.getBallotByIndex);
...
routes.put('/votacion/estado', tokenController.verifyToken, votacionController.updateVotacionEstado);
